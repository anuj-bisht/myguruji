...
<body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="{{ route('tutorials') }}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Tutorials</span></a></li>
		<li><a class="app-menu__item active" href="{{ route('teachers') }}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Teachers</span></a></li>
		<li><a class="app-menu__item active" href="{{ route('chapters') }}"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Chapters</span></a></li>
